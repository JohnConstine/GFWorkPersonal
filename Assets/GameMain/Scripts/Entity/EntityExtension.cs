...
namespace StarForce
{
    public static class EntityExtension
    {
        ...
        public static void ShowTheMap(this EntityComponent entityComponent, MapData mapData)
        {
            entityComponent.ShowEntity(typeof(Map),"Map",Constant.AssetPriority.Map,mapData);
        }
